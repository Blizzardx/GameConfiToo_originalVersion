...
{
    /// <summary>
    /// chatDirtywordConfig配置的导出实现
    /// </summary>
    public class ChatDirtyWordExporter : AbstractExcelExporter
    {
        private static log4net.ILog logger = log4net.LogManager.GetLogger(typeof(ChatDirtyWordExporter));
